...
-- Generated: 2026-01-03T20:30:00.247Z
...
INSERT INTO "announcements" ("id", "title", "content", "priority", "status", "target", "publishAt", "expiresAt", "sendEmail", "sendSMS", "createdById", "schoolId", "attachments", "views", "createdAt", "updatedAt") VALUES (5, 'xcvxcvcxv', 'xcvxcvxcvx', 'medium', 'published', 'all', '2026-01-03T11:45:00.000Z', '2026-01-03T12:45:00.000Z', false, false, 4, 9, NULL, 0, '2026-01-03T06:15:46.130Z', '2026-01-03T06:15:55.161Z');
...
-- Table: fee_generation_history
DROP TABLE IF EXISTS "fee_generation_history" CASCADE;
CREATE TABLE "fee_generation_history" (
  "id" integer NOT NULL DEFAULT nextval('fee_generation_history_id_seq'::regclass),
  "type" USER-DEFINED NOT NULL,
  "status" USER-DEFINED NOT NULL DEFAULT 'pending'::fee_generation_history_status_enum,
  "schoolId" integer NOT NULL,
  "academicYearId" integer NOT NULL,
  "totalStudents" integer NOT NULL,
  "feesGenerated" integer NOT NULL DEFAULT 0,
  "feesFailed" integer NOT NULL DEFAULT 0,
  "errorMessage" text,
...
INSERT INTO "migrations" ("id", "timestamp", "name") VALUES (5, '1767600000000', 'AddStudentAdditionalFields1767600000000');
INSERT INTO "migrations" ("id", "timestamp", "name") VALUES (6, '1767700000000', 'AddFeeGenerationFields1767700000000');
...
INSERT INTO "student_academic_records" ("id", "studentId", "academicYearId", "classId", "section", "rollNumber", "admissionNumber", "remarks", "createdAt", "updatedAt", "status", "schoolId") VALUES (4, 4, 4, 19, NULL, NULL, NULL, NULL, '2026-01-03T07:05:48.087Z', '2026-01-03T07:05:48.087Z', 'active', 9);
INSERT INTO "student_academic_records" ("id", "studentId", "academicYearId", "classId", "section", "rollNumber", "admissionNumber", "remarks", "createdAt", "updatedAt", "status", "schoolId") VALUES (1, 1, 4, 1, 'Commodo in odio exer', NULL, NULL, NULL, '2026-01-01T03:31:22.241Z', '2026-01-03T09:12:32.704Z', 'active', 9);
...
CREATE TABLE "students" (
  ...
  "routeId" integer,
  "routePlanId" integer,
  "busNumber" character varying(50),
  "busSeatNumber" character varying(50),
  "shift" character varying(50),
  "openingBalance" numeric DEFAULT '0'::numeric,
  "bankName" character varying(255),
  "branchName" character varying(255),
  "bankIfsc" character varying(20),
  "bankAccountNumber" character varying(50),
  "penNumber" character varying(50),
  "aadharNumber" character varying(20),
  "admissionFormNumber" character varying(50),
...
INSERT INTO "students" ("id", "userId", "studentId", "firstName", "lastName", "email", "phone", "address", "status", "schoolId", "createdAt", "updatedAt", "dateOfBirth", "gender", "bloodGroup", "admissionDate", "admissionNumber", "photoUrl", "parentName", "parentEmail", "parentPhone", "parentRelation", "routeId", "routePlanId", "busNumber", "busSeatNumber", "shift", "openingBalance", "bankName", "branchName", "bankIfsc", "bankAccountNumber", "penNumber", "aadharNumber", "admissionFormNumber", "whatsappNo", "categoryHeadId", "isSibling") VALUES (2, NULL, '2', 'Aamir', 'Bashir', 'aamir@gmail.com', '7006124578', NULL, 'active', 9, '2026-01-01T03:44:29.127Z', '2026-01-03T06:53:28.590Z', NULL, NULL, NULL, '2025-12-31T18:30:00.000Z', 'ADM-004', NULL, 'Bashir Ahmad', NULL, '7006457898', 'father', 4, 4, NULL, NULL, NULL, '0.00', NULL, NULL, NULL, NULL, NULL, '784512784578', '005', '7006568923', NULL, false);
INSERT INTO "students" ("id", "userId", "studentId", "firstName", "lastName", "email", "phone", "address", "status", "schoolId", "createdAt", "updatedAt", "dateOfBirth", "gender", "bloodGroup", "admissionDate", "admissionNumber", "photoUrl", "parentName", "parentEmail", "parentPhone", "parentRelation", "routeId", "routePlanId", "busNumber", "busSeatNumber", "shift", "openingBalance", "bankName", "branchName", "bankIfsc", "bankAccountNumber", "penNumber", "aadharNumber", "admissionFormNumber", "whatsappNo", "categoryHeadId", "isSibling") VALUES (3, NULL, '3', 'sdsd', 'sdsd', 'dsds@dfdf.fddf', '97979797979797', NULL, 'active', 9, '2026-01-01T10:12:06.318Z', '2026-01-03T08:24:18.099Z', NULL, NULL, NULL, '2025-12-31T18:30:00.000Z', NULL, NULL, 'gdfgfd', NULL, '7006787878', 'father', NULL, NULL, NULL, NULL, NULL, '0.00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '9797979797979', NULL, false);
INSERT INTO "students" ("id", "userId", "studentId", "firstName", "lastName", "email", "phone", "address", "status", "schoolId", "createdAt", "updatedAt", "dateOfBirth", "gender", "bloodGroup", "admissionDate", "admissionNumber", "photoUrl", "parentName", "parentEmail", "parentPhone", "parentRelation", "routeId", "routePlanId", "busNumber", "busSeatNumber", "shift", "openingBalance", "bankName", "branchName", "bankIfsc", "bankAccountNumber", "penNumber", "aadharNumber", "admissionFormNumber", "whatsappNo", "categoryHeadId", "isSibling") VALUES (1, NULL, 'Enim porro est dolo', 'Esse', 'fugit quia ex', 'coqepu@mailinator.com', '+1 (395) 981-2276', NULL, 'active', 9, '2026-01-01T03:31:22.180Z', '2026-01-03T09:12:56.761Z', NULL, NULL, NULL, '1983-07-10T18:30:00.000Z', 'Ut irure in dolore m', NULL, 'Qui adipisci impedit', NULL, '+1 (835) 607-2269', 'father', NULL, NULL, NULL, NULL, NULL, '20000.00', NULL, NULL, NULL, NULL, 'Cupidatat adipisicin', 'Proident ac', 'Nemo quo quam except', '+1 (506) 403-2715', NULL, false);
INSERT INTO "students" ("id", "userId", "studentId", "firstName", "lastName", "email", "phone", "address", "status", "schoolId", "createdAt", "updatedAt", "dateOfBirth", "gender", "bloodGroup", "admissionDate", "admissionNumber", "photoUrl", "parentName", "parentEmail", "parentPhone", "parentRelation", "routeId", "routePlanId", "busNumber", "busSeatNumber", "shift", "openingBalance", "bankName", "branchName", "bankIfsc", "bankAccountNumber", "penNumber", "aadharNumber", "admissionFormNumber", "whatsappNo", "categoryHeadId", "isSibling") VALUES (4, NULL, '4', 'Aamir', 'Bashir', 'aamir1@gmail.com', '7006124578', NULL, 'active', 9, '2026-01-03T07:05:47.999Z', '2026-01-03T12:01:51.093Z', NULL, NULL, NULL, '2026-01-02T18:30:00.000Z', NULL, '/uploads/students/student-1767449168370-5ho34z66xnt.png', 'Bashir Ahmad', NULL, '7006457898', 'father', 5, 4, NULL, NULL, NULL, '100.00', NULL, NULL, NULL, NULL, NULL, NULL, '005', '7006568923', 7, false);
