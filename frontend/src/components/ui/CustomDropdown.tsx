  ...
  return (
    <div ref={dropdownRef} className={`relative ${className}`}>
      ...
      <button
        ...
        className={`w-full px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-300 cursor-pointer relative ${
          darkMode
            ? "bg-gradient-to-br from-gray-800/90 to-gray-900/90 backdrop-blur-xl border border-indigo-500/50 text-gray-100 hover:border-indigo-400 hover:shadow-[0_0_20px_rgba(99,102,241,0.4)] focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/30 shadow-[0_4px_15px_rgba(0,0,0,0.3)]"
            : "bg-white border border-indigo-400/60 text-gray-900 hover:border-indigo-500 hover:shadow-[0_4px_20px_rgba(99,102,241,0.3)] focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 shadow-sm"
        } ${
          isOpen
            ? darkMode
              ? "border-indigo-400 shadow-[0_0_25px_rgba(99,102,241,0.5)]"
              : "border-indigo-500 shadow-[0_4px_25px_rgba(99,102,241,0.4)]"
            : ""
        }`}
      >
        ...
        <svg
          className={`absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 transition-transform duration-300 ${
            isOpen ? "rotate-180" : ""
      ...
      {isOpen && (
        <div
          className={`absolute z-[9999] w-full rounded-xl border-2 overflow-hidden shadow-2xl ${
